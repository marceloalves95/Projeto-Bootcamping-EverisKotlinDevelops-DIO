package chellotech.br.projeto_bootcamping_everiskotlindevelops_dio.outros
...
import chellotech.br.projeto_bootcamping_everiskotlindevelops_dio.telas.NotificationsMain
...
fun Context.showNotification(channelId:String, title:String, body:String ){
    ...
    val intent = Intent(this,NotificationsMain::class.java)
